...
import { PosAgentLinkManager } from "@/features/inventory/components/PosAgentLinkManager";
...
const INV_TABS = ["dash", "pos", "barcode", "credit", "reports", "agent"] as const;
      ...
      <Tabs value={invTab} onValueChange={onInvTabChange} className="w-full">
        <TabsList className="flex flex-wrap h-auto bg-[#0a1628] border border-slate-800 p-1 gap-1">
          ...
          <TabsTrigger value="agent" className="gap-1">
            ...
            {t("inv.tab.agent") || "تطبيق المندوبين"}
          </TabsTrigger>
        </TabsList>
