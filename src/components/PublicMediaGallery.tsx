  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-8 text-slate-500 text-sm">
        <img
          src="/hero-team.png"
          alt="Smart Al-Idara Pro"
          className="w-full h-48 object-cover rounded-lg mb-4"
        />
        <p className="text-slate-400">المنصة توفر لكم الوقت والميزانية والجهد</p>
        <p className="text-slate-400 text-xs mt-1">قم بتجربة مجانية 7 أيام + الدعم لا تضيع الفرصة</p>
      </div>
    );
  }
