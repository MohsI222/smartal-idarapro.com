...
const AR: ContractPdfClauseCopy = {
  ...
  kingdomOther: "",
  introAr:
    "تمهيد: يُبرم هذا الاتفاق بين ممثل منصّة Smart Al-Idara Pro (الطرف الأول) وبين المشترك المُحدَّد أعلاه (الطرف الثاني)، وفقاً للتشريع الجاري به العمل المتعلق بحماية المعطيات ذات الطابع الشخصي (القانون 09-08) والمقتضيات المتعلقة بالاقتصاد الرقمي بالمغرب.",
  introOther: "",
  partiesAr:
  ...
  objectOther: "",
  financialAr:
    "الالتزامات المالية: يُسدَّد الأجر وفق الدورة المختارة (شهرية أو سنوية) بالدرهم المغربي، عبر الوسائل المعتمدة من المنصّة (تحويل بنكي، وكلاء معتمدون، أو بوابة دفع عند توفرها). لا تُعتبر الخدمة مؤكدة إلا بعد استيفاء إجراءات التحقق الإدارية للدفع عند الاقتضاء.",
  financialOther: "",
  durationAr:
