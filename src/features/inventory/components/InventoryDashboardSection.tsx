                    ...
                    <td className="py-2">
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) => onEditProductChange(product.id, { pieces_per_carton: Number(e.target.value) })}
                        />
                      ) : (
                    ...
                    <td className="py-2">
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) => onEditProductChange(product.id, { unit_price: Number(e.target.value) })}
                        />
                      ) : (
                        product.unit_price
                      )}
                    ...
                    <td className="py-2 text-slate-400">
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) => onEditProductChange(product.id, { cost_price: Number(e.target.value) })}
                        />
                      ) : (
                    ...
                    <td className="py-2 text-emerald-400 font-bold">
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) => onEditProductChange(product.id, { stock_pieces: Number(e.target.value) })}
                        />
                      ) : (
                    ...
                    <td className="py-2 text-xs">
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) => onEditProductChange(product.id, { low_stock_alert: Number(e.target.value) })}
                        />
                      ) : (
