...
export const PLAN_OPTIONS: PlanOption[] = [
  ...
  },
  {
    ...
    priceYearlyDh: 5000,
    accent: "rose",
    modules: ["lawyer", "legal_ai", "law", "members", "acc", "hr", "inventory", "reminders", "chat"],
  },
  {
    id: "libraries_base",
  ...
  },
  {
    ...
    priceYearlyDh: 5000,
    accent: "fuchsia",
    modules: ["visa", "legal_ai", "inventory", "acc", "gov", "chat", "reminders"],
  },
  {
    id: "cars_real_estate",
  ...
  {
    id: "retail_pro",
    labelKey: "plan.retailPro",
    blurbKey: "plan.retailPro.blurb",
    priceMonthlyDh: 799,
    priceYearlyDh: 7670,
    accent: "rose",
  ...
  },
  {
    ...
    labelKey: "plan.deliveryHubOnly",
    blurbKey: "plan.deliveryHubOnly.blurb",
    priceMonthlyDh: 2500,
    priceYearlyDh: 24000,
    accent: "emerald",
    modules: ["delivery_hub", "chat"],
  },
  {
    id: "institutes",
